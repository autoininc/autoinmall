module.exports = function(app, db, multer) {
	...
	router.get("/signin/confirm", (req, res) => { signin.confirm(req, res, db) });

	router.get("/signup", (req, res) => { signup.show(req, res, db) });
	router.get("/signup/checkaccount", (req, res) => { signup.checkaccount(req, res, db) });
	router.post("/signup/confirm", (req, res) => { signup.confirm(req, res, db) });
	...
	router.post("/account/password", (req, res) => { account.password(req, res, db) });
	router.post("/account/certification", (req, res) => { account.certification(req, res, db) });
	...
	router.post("/admin/item/add", upload.fields([{ name: 'item_img', maxCount: 5 }, { name: "file", maxCount: 5 }]), (req, res) => { admin.item_add(req, res, db) });
	router.post("/admin/item/delete", (req, res) => { admin.item_delete(req, res, db) });
	...
	router.post('/admin/file/delete', (req, res) => { admin.file_delete(req, res, db) });
	router.post('/admin/img/delete', (req, res) => { admin.img_delete(req, res, db) });
	...
	router.post("/admin/car_brand/delete", (req, res) => { admin.carbrand_delete(req, res, db) });
